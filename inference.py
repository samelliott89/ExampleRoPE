...
if __name__ == "__main__":
    ...
    parser.add_argument("--eval", action="store_true", help="Evaluate perplexity instead of generating")
    parser.add_argument("--eval-batches", type=int, default=100, help="Number of batches for perplexity eval")
    ...
    parser.add_argument("--top-p", type=float, default=0.9, help="Top-p nucleus sampling (1.0 to disable)")
    parser.add_argument("--repetition-penalty", type=float, default=1.2, help="Repetition penalty (1.0 to disable)")
    ...
    if args.eval:
        ...
        print(f"\n--- Prompt: '{args.prompt}' ---")
        print(f"--- temp={args.temperature}, top_k={args.top_k}, top_p={args.top_p}, rep_pen={args.repetition_penalty} ---\n")
